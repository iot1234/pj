    ...
    <div class="admin-main">
        ...
        <main class="admin-content" id="main-content" tabindex="-1">
            ...
            <section class="admin-view" data-admin-view="meters" aria-labelledby="meters-title" hidden>
                ...
                <div class="toolbar toolbar-period"><label><span>รอบเดือน</span><input type="month" id="meter-period" max="<?= e($maximumBillingPeriod) ?>" required></label><p class="toolbar-note">ค่าที่กรอกต้องไม่น้อยกว่าครั้งก่อน</p><p class="toolbar-progress" id="meter-progress" role="status">—</p><button class="button button-secondary" id="meter-recovery-return" type="button" hidden>กลับงวดเดิม</button></div>
                <div class="security-note meter-baseline-note" role="note"><strong>ตรวจเลขมิเตอร์เริ่มต้นก่อนบันทึก</strong><span>ระบบดึงเลขก่อนหน้าให้เอง หากขาดประวัติให้กดเติมงวดที่ระบุ อย่าใส่ศูนย์แทน เดือนที่มีผู้พักต้องใช้เลขจริงของผู้พักรอบเดียวกัน เปลี่ยนเดือนแล้วร่างยังอยู่ในหน้านี้ แต่ปิดหรือรีเฟรชทั้งหน้าอาจทำให้ร่างหาย</span></div>
