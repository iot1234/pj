<?php
namespace Dormitory\Support\Vendor;
// Vendored from kazuhikoarase/qrcode-generator @ 83b7e8fe3fddd3b0368dbafd6ce56995bd25e3c8.
// Local compatibility: isolated namespace; three stateless helpers declared static.
...
class QRCode {
    ...
    static function createNullArray($length) {
        $nullArray = array();
        for ($i = 0; $i < $length; $i++) {
            $nullArray[] = null;
        }
    ...
    static function createData($typeNumber, $errorCorrectLevel, $dataArray) {
     ...
     * @return array
     */
    static function createBytes(&$buffer, &$rsBlocks) {
